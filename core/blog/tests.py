...
class TestBlogApi:
    ...
    #get a post detail
    def test_get_post_detail__status_200(self,api_client,fakepost):   
        post = fakepost
    ...
    def test_send_authenticated_comment_201_status(self,api_client,fakepost,fakeuser1):
        post = fakepost
    ...
    def test_change_request_get_allversions_200_status(self,api_client,fakepost,fakeuser1):
        post = fakepost
        api_client.force_authenticate(user=fakeuser1)
        url = reverse('blog:api-v1:author-change-request',kwargs={'pk':post.id})
        response = api_client.get(url) 
    ...
    def test_non_author_change_request_send_404_status(self,api_client,fakepost,fakeuser2):
        post = fakepost
